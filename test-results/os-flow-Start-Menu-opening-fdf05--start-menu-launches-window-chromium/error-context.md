...
- Name: os-flow.spec.ts >> Start Menu >> opening About from start menu launches window
- Location: tests\os-flow.spec.ts:168:7
...
- main:
  - img "Wallpaper"
  - text: ● 06:44:11 ⬡ Desktop Still Woozy - Lava
  - button
  - button
  - button
  - text: 85%
