...
- Name: os-flow.spec.ts >> Window Management >> traffic light close button (red) closes window
- Location: tests\os-flow.spec.ts:188:7
...
- main:
  - img "Wallpaper"
  - text: ● 06:45:20 ⬡ Desktop Still Woozy - Lava
  - button
  - button
  - button
  - text: 85%
