...
- Name: os-flow.spec.ts >> Start Menu >> opening Terminal from start menu launches window
- Location: tests\os-flow.spec.ts:163:7
...
- main:
  - img "Wallpaper"
  - text: ● 06:43:36 ⬡ Desktop Still Woozy - Lava
  - button
  - button
  - button
  - text: 85%
