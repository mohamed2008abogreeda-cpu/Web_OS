...
- Name: os-flow.spec.ts >> Window Management >> traffic light minimize button (yellow) hides window
- Location: tests\os-flow.spec.ts:201:7
...
- main:
  - img "Wallpaper"
  - text: ● 06:45:40 ⬡ Desktop Still Woozy - Lava
  - button
  - button
  - button
  - text: 85%
